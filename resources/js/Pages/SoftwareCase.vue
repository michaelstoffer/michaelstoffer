...
<template>
    <AppLayout>
        ...
        <section class="pt-12 sm:pt-16 pb-8 max-w-3xl">
            <img v-if="props.case.cover" :src="props.case.cover" :alt="`${props.case.title} cover`" class="w-full rounded-2xl border border-slate-200 aspect-video object-cover mb-8" fetchpriority="high" width="1600" height="900" />
